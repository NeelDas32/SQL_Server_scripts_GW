/*
    This script will generate 3 reports that give an overall or high level view 
    of the indexes in a particular database. The sections are as follows:
...
SELECT DISTINCT cast(I.[Table Name] as char(32)) TableName, 
cast(I.[Index Name] as char(32)) IndexName ,I.[Index Type],  I.[Constraint Type], I.[AllColName] 
    FROM @AllIndexes AS I
    ...
    ORDER BY TableName, I.[AllColName] 

----------
SELECT 'Listing Possible Reverse Index keys' AS [Comments] 

SELECT DISTINCT cast(I.[Table Name] as char(32)) Tabname, 
cast(I.[Index Name] as char(32)) IndexName , I.[Index Type],  I.[Constraint Type], I.[AllColName] 
    FROM @AllIndexes AS I
        JOIN @AllIndexes AS I2
            ON I.[Table ID] = I2.[Table ID] 
