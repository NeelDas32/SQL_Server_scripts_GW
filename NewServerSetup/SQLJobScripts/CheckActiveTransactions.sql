...
/****** Object:  Job [Check Active Transactions]    Script Date: 06/02/2015 10:14:55 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 06/02/2015 10:14:55 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Check for Active Transactions]    Script Date: 06/02/2015 10:14:56 ******/
...
IF @rowcount > 0 and @message_dtl is not NULL
  BEGIN 
      ...
      EXEC msdb..sp_send_dbmail @recipients = @recipient_list , @body=@message, @subject=@e_subject, @body_format = ''HTML'';
  END
