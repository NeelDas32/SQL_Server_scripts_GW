/*****************************************************************************
 Update Statistics for each database where row modification > 500.
 Author: S. Kratzer
 Date: 08/31/2012
******************************************************************************/
USE [GWRE_IT]
...
GO
-- DROP procedure  [dbo].[gwre_UpdateStatistics];
GO
...
DELETE FROM [GWRE_IT].[dbo].[UpdateStats] WHERE DB_NAME=@DBName
	  
-- Load the UpdateStats table
EXEC ('USE ['+@DBName+'];
      INSERT INTO [GWRE_IT].[dbo].[UpdateStats]
