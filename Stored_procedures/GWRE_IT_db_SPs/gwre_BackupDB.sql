...
/****** Object:  StoredProcedure [dbo].[gwre_BackupDB]    Script Date: 7/30/2024 11:15:50 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[gwre_BackupDB]  
        @DBName sysname, 
...
/* Modified the filename, placing an underscore between the date and timestamp - srk 04/2012 */
...
/* Modified Database backup extension to use .bkp instead of .bak - srk 04/2012 */

IF @BackupType = 0 
  BEGIN 
        SET @BAKExtension = '.bkp' 
...
/* Added Compression to SQL command - srk 04/2012 */
...
SET @SQL = 'Backup ' + @BackupTypeStr + SPACE(1) + 
        ...
        'With Init, Compression,' + CHAR(10) + CHAR(9) + CHAR(9) + 
